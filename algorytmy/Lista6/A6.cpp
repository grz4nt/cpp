...
enum class typDanych
{
    calkowite,
    rzeczywiste
};
enum class algorytmSortowania
{
    bubble,
    selection,
    insertion,
...
typDanych wybierzDane()
{
    ...
    {
    case 1:
        return typDanych::calkowite;
    case 2:
        return typDanych::rzeczywiste;
    default:
...
algorytmSortowania wybierzAlgorytm()
{
    ...
    std::cout << "9. Wszystkie algorytmy\n";
    std::cin >> wybor;

    switch (wybor)
    {
    case 1:
        return algorytmSortowania::bubble;
    case 2:
        return algorytmSortowania::selection;
    case 3:
        return algorytmSortowania::insertion;
    case 4:
        return algorytmSortowania::merge;
    case 5:
        return algorytmSortowania::counting;
    case 6:
        return algorytmSortowania::heap;
    case 7:
        return algorytmSortowania::bucket;
    case 8:
        return algorytmSortowania::quicksort;
    case 9:
        return algorytmSortowania::wszystkie;
    default:
        std::cout << "Nieprawidlowy wybor!\n";
...
public:
    ...
    void bubbleSort()
    {
        ...
        clock_t end = clock();
        double czasSortowania = double(end - start) / CLOCKS_PER_SEC * 1000;
        std::cout << "Czas sortowania: " << czasSortowania << "ms (" << czasSortowania/1000 << " sekund)" << std::endl;
    }
    ...
    void bucketSort()
    {
        ...
        int max_value = *std::max_element(dane.begin(), dane.end());

        for (int i = 0; i < dane.size(); i++)
        {
            int bucketIndex = static_cast<int>(dane.size() * (static_cast<double>(dane[i]) / (max_value + 1)));
    ...
    void sort(algorytmSortowania algorithm)
    {
        switch (algorithm)
        {
        case algorytmSortowania::bubble:
            bubbleSort();
            break;
        case algorytmSortowania::selection:
            selectionSort();
            break;
        case algorytmSortowania::insertion:
            insertionSort();
            break;
        case algorytmSortowania::merge:
            mergeSort();
            break;
        case algorytmSortowania::counting:
            countingSort();
            break;
        case algorytmSortowania::heap:
            heapSort();
            break;
        case algorytmSortowania::bucket:
            bucketSort();
            break;
        case algorytmSortowania::quicksort:
            quickSort();
            break;
